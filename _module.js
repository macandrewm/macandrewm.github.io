...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			...
			attr(link0, "href", "https://edqjpryjjnqukkwhzcjp.supabase.co/storage/v1/object/public/images/e_favicon.png?t=2023-10-15T23%3A28%3A00.376Z");
			document.title = "elio";
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h() {
			...
			attr(div1, "class", "component svelte-ofha1n");
			attr(div2, "class", "section svelte-ofha1n");
			attr(div2, "id", "section-4d541e9a-bd96-4514-9ee1-4191ff4dd7ef");
		},
		m(target, anchor) {
			insert_hydration(target, div2, anchor);
			append_hydration(div2, div1);
...
function create_each_block(ctx) {
	...
	return {
		...
		h() {
			...
			attr(a, "class", "svelte-1tzh3q");
			attr(li, "class", "svelte-1tzh3q");
		},
		m(target, anchor) {
...
function create_fragment$5(ctx) {
	...
	return {
		...
		h() {
			attr(ul, "class", "svelte-1tzh3q");
			attr(div0, "class", "card");
			attr(section, "class", "section-container svelte-1tzh3q");
			attr(div1, "class", "component");
			attr(div2, "class", "section");
...
function create_fragment$6(ctx) {
	...
	return {
		...
		h() {
			attr(h2, "class", "svelte-izk7s6");
			attr(span0, "class", "asterisk");
			attr(label, "for", "mce-EMAIL");
			attr(label, "class", "svelte-izk7s6");
			attr(input0, "type", "email");
			attr(input0, "name", "EMAIL");
			attr(input0, "class", "required email svelte-izk7s6");
			attr(input0, "id", "mce-EMAIL");
			input0.required = "";
			input0.value = "";
			attr(span1, "id", "mce-EMAIL-HELPERTEXT");
			attr(span1, "class", "helper_text svelte-izk7s6");
			...
			attr(input2, "class", "button svelte-izk7s6");
			...
			attr(div5, "class", "clear foot svelte-izk7s6");
			attr(div6, "class", "optionalParent");
			attr(div7, "id", "mc_embed_signup_scroll");
			attr(div7, "class", "svelte-izk7s6");
			...
			attr(form, "class", "validate svelte-izk7s6");
			attr(form, "target", "_blank");
			attr(div8, "id", "mc_embed_signup");
			attr(div8, "class", "svelte-izk7s6");
